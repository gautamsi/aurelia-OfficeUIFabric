...
gulp.task('build', function (callback) {
  return runSequence(
    'clean-build', ['build-json', 'build-js', 'build-woff2', 'build-css', 'build-html', 'build-system', 'copy-config'],
    //'clean-build', ['build-json', 'build-js', 'build-woff2', 'build-css', 'build-html', 'build-es2015', 'build-amd', 'build-system', 'build-commonjs', 'copy-config'],
    callback
  );
});
