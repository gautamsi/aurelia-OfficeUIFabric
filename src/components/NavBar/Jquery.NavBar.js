    ...
    $.fn.NavBar = function () {
        ...
        return this.each(function () {
            ...
            $navBar.on('click', '.ms-NavBar-item:not(.is-disabled)', function (event) {
                ...
                $navBar.find('.ms-NavBar-item').removeClass('is-selected'); // to find correct siblings, this is no longer sibling, it is now parent's sibling's child
                ...
                if ($(this).hasClass('ms-NavBar-item--hasMenu')) {
                    ...
                    $(this).find('.ms-ContextualMenu:first').toggleClass('is-open');
