...
import { PanelHost } from "../PanelHost/msPanelHost";
  /**
   * Panel Host
   *
  ...
  export class Panel {
     ...
     * @constructor
     */
    constructor(panel: Element, callback: Function = null,  direction?: string, animateOverlay?: boolean) {
      this._panel = panel;
      ...
      this._clickHandler = this.dismiss.bind(this, callback);
      this._setEvents();
